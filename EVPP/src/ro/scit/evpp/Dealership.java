...
public class Dealership extends Thread {
    ...
    public synchronized void sellCar(Car selectedCarToBuy, Integer amountOfCar, Customer customer) throws InsufficientFundsException, OutOfStockException {
    ...
    public void requestGreenBonus(Car selectedCarToBuy, Integer amountOfCar, Customer customer) throws OldCarException, GreenBonusProgram.InsufficientFundsException, InterruptedException {
